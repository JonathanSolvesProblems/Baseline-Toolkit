...
function App() {
  ...
  // If no report loaded, prompt user to upload
  if (!data) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4 text-center">
        <Shield className="h-12 w-12 text-primary-600 mb-4" />
        <h1 className="text-2xl font-semibold text-gray-900 mb-2">No Baseline Report Loaded</h1>
        <p className="text-gray-600 mb-6 max-w-md">
          Please upload a JSON report generated by the Baseline Toolkit VS Code extension. You can
          generate this JSON file by following the steps in our{' '}
          <a
  ...
  // Render dashboard once JSON is uploaded
  return (
